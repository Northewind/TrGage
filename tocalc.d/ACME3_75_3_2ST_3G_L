...
###### Параметры калибров-пробок 3.75"-3 ACME-2 STARTS-3G-LEFT ######

plug.go.d2 = 91.055 + [-0.02 0.02];
plug.ng.d2 = 91.535  + [-0.02 0.02];
#ring.go.D2 = 126.62  + [-0.026 0.026];
#ring.ng.D2 = 126.224 + [-0.026 0.026];
plug.go.P   = plug.ng.P   = ring.go.P   = ring.ng.P   = thr.P   = 25.4/3;
plug.go.Ph  = plug.ng.Ph  = ring.go.Ph  = ring.ng.Ph  = thr.Ph  = 25.4/3*2;
